...
export class TileCreation extends Component {
    ...
    placeColor(hexagonTile: Node, colorIndex: number) {
        ...
        hexagonTile.children[0].getComponent(MeshRenderer).setMaterial(material, 0);
